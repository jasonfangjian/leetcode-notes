...
public class LargestDivisibleSubset {
    ...
    public List<Integer> largestDivisibleSubset(int[] nums) {
        ...
        dp[0] = new ArrayList(Arrays.asList(nums[0]));
        list = dp[0];
        for(int i = 1; i < nums.length; i++){
            ...
            List<Integer> dCopy = new ArrayList<>(temp);
            dCopy.add(nums[i]);
            if(dCopy.size() > list.size())
                list = dCopy;
            dp[i] = dCopy;
        }
