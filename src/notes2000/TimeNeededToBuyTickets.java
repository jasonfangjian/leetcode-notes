...
public class TimeNeededToBuyTickets {
    public static void main(String[] args){
        System.out.println(new TimeNeededToBuyTickets().timeRequiredToBuy(new int[]{2,3,2},2));
        System.out.println(new TimeNeededToBuyTickets().timeRequiredToBuy(new int[]{5,1,1,1},0));
    }
